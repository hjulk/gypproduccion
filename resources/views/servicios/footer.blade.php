<footer class="site-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h2 class="footer-heading mb-4" id="titulofooter">Grúas y Parqueaderos Bogotá S.A.S</h2>
                <ul class="list-unstyled">
                    <li><span class="icon icon-map-marker"></span>&nbsp;Calle 55 # 73 - 19, Bogotá, Colombia</li>
                    <li><a href="tel:+5719279254"><span class="icon icon-phone"></span>&nbsp;+57(1) 9279254 - 3124985077</a></li>
                    <li><a href="mailto:denuncias@gypbogota.com"><span class="icon icon-envelope"></span>&nbsp;denuncias@gypbogota.com</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <h2 class="footer-heading mb-4"><b>INFORMACIÓN</b></h2>
                <ul class="list-unstyled">
            ...
            <div class="col-md-4" id="titulo1footer">
                <img src="{{asset("images/footer-black.png")}}" alt="" id=footerImg><br><br>
                <h2 class="footer-heading mb-4">Contrato de Concesión No. 2018-114</h2>
            </div>
        </div>
