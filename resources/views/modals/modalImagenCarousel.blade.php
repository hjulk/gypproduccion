<div class="modal fade bd-example-modal-xl" id="modal-carouselUpd" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title modal-title-primary">Actualizar Imagen Carrusel</h4>
            </div>
            {!! Form::open(['url' => 'actualizarImagenCarousel', 'method' => 'post', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-imagen_upd']) !!}
            @csrf
            <div class="modal-body">
                <div class="form-group">
                    <input type="hidden" name="id_imagenCarousel" id="idImagenCarousel_upd">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="exampleInputEmail1">Nombre Imagen</label>
                            {!! Form::text('nombre_imagen_upd',null,['class'=>'form-control','id'=>'mod_nombre_imagen_carousel','placeholder'=>'Nombre Imagen','required']) !!}
                        </div>
                        <div class="col-md-4">
                            <label for="exampleInputEmail1">Orden Imagen</label>
                            {!! Form::select('orden_upd',$OrdenUpd,null,['class'=>'form-control','id'=>'mod_orden_carousel','required']) !!}
                        </div>
                        <div class="col-md-4">
                            <label for="exampleInputEmail1">Estado</label>
                            {!! Form::select('estado_upd',$Estado,null,['class'=>'form-control','id'=>'mod_estado_carousel','required']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12" id="imageCarouselUpdate">
