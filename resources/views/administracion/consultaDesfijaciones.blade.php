...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-newspaper nav-icon" id="enlace"></i> Reporte Desfijaciones</h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="box-footer">
                                {!! Form::button('Consultar',array('class'=>'btn btn-primary pull-right','id'=>'btnConsultaDesfijaciones','tabindex'=>'16')) !!}
                            </div>
                        {!!  Form::close() !!}
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" id="panelResultado">
                        <table id="consultaDesfijaciones" class="display table dt-responsive nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Contenido</th>
