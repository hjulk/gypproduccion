...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-file nav-icon" id="enlace"></i> Imágenes Página Nosotros</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['url' => 'crearImagenNosotros', 'method' => 'post', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-imagen']) !!}
                                @csrf
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <table id="nosotros" class="display table dt-responsive nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nombre Imagen</th>
                            ...
                            <tbody>
                                @foreach($Nosotros as $value)
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-warning" title="Editar" data-toggle="modal" data-target="#modal-nosotrosUpd" onclick="obtener_datos_imagen_nosotros('{{$value['id']}}');"><i class="fas fa-edit"></i></a></td>
...
@include("modals.modalImagenNosotros")
