...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-file nav-icon" id="enlace"></i> Imágenes Página Consulta Liquidación</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['url' => 'crearImagenSettlementConsultation', 'method' => 'post', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-imagen']) !!}
                                @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="settlementConsultation" class="display table dt-responsive nowrap" style="width: 100%;">
                            ...
                            <tbody>
                                @foreach($SettlementConsultation as $value)
                                    <tr>
                                        <td>{{$value['id']}}</td>
                                        ...
                                        <td><a href="#" class="btn btn-warning" title="Editar" data-toggle="modal" data-target="#modal-settlementConsultationUpd" onclick="obtener_datos_imagen_settlementConsultation('{{$value['id']}}');"><i class="fas fa-edit"></i></a></td>
