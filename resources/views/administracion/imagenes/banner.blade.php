...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-file nav-icon" id="enlace"></i> Imágenes Sección Banner</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header" id="principalCard">
                        <h3 class="card-title" id="tituloCard"><strong>Cargar Imagen Banner</strong></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['url' => 'crearImagenBanner', 'method' => 'post', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-imagen']) !!}
                                @csrf
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="exampleInputEmail1">Nombre Imagen</label>
                                                {!! Form::text('nombre_imagen_banner',null,['class'=>'form-control','id'=>'nombre_imagen_banner','placeholder'=>'Nombre Imagen','required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <table id="banner" class="display table dt-responsive nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nombre Imagen</th>
                            ...
                            <tbody>
                                @foreach($Banner as $value)
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-warning" title="Editar" data-toggle="modal" data-target="#modal-bannerUpd" onclick="obtener_datos_imagen_banner('{{$value['id']}}');"><i class="fas fa-edit"></i></a></td>
...
@include("modals.modalImagenBanner")
