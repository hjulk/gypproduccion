...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-file nav-icon" id="enlace"></i> Imágenes Página Beneficios</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::open(['url' => 'crearImagenBenefits', 'method' => 'post', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-imagen']) !!}
                                @csrf
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <label for="exampleInputEmail1">Nombre Imagen</label>
                                                {!! Form::text('nombre_imagen_benefits',null,['class'=>'form-control','id'=>'nombre_imagen_benefits','placeholder'=>'Nombre Imagen','required']) !!}
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::textarea('texto_imagen',null,['class'=>'form-control','id'=>'texto_imagen','rows'=>'3', 'cols' => '100']) !!}                                                
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        <table id="benefits" class="display table dt-responsive nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nombre Imagen</th>
                            ...
                            <tbody>
                                @foreach($Beneficios as $value)
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-warning" title="Editar" data-toggle="modal" data-target="#modal-benefitsUpd" onclick="obtener_datos_imagen_benefits('{{$value['id']}}');"><i class="fas fa-edit"></i></a></td>
                                        ...
                                        <input type="hidden" value="{{$value['texto_imagen']}}" id="texto_imagen{{$value['id']}}">
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
@include("modals.modalImagenBenefits")
